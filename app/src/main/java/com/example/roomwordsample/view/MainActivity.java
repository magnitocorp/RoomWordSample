...
//                        .setAction("Action", null).show();
         ...
         * When the activity is destroyed, for example through a configuration change, t
         * he ViewModel persists. When the activity is re-created, the ViewModelProviders return the existing ViewModel.
         */
